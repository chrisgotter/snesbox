...
namespace Snes
{
    partial class CPUCore
    {
        public class Reg24
        {
            ...
            public static explicit operator uint(Reg24 reg24) { throw new NotImplementedException(); }
            public uint Assign(uint i) { throw new NotImplementedException(); }
            public static uint operator |(Reg24 reg24, uint i) { throw new NotImplementedException(); }
            public static uint operator ^(Reg24 reg24, uint i) { throw new NotImplementedException(); }
            public static uint operator &(Reg24 reg24, uint i) { throw new NotImplementedException(); }
            public static uint operator <<(Reg24 reg24, int i) { throw new NotImplementedException(); }
            public static uint operator >>(Reg24 reg24, int i) { throw new NotImplementedException(); }
            public static uint operator +(Reg24 reg24, uint i) { throw new NotImplementedException(); }
            public static uint operator -(Reg24 reg24, uint i) { throw new NotImplementedException(); }
            public static uint operator *(Reg24 reg24, uint i) { throw new NotImplementedException(); }
            public static uint operator /(Reg24 reg24, uint i) { throw new NotImplementedException(); }
            public static uint operator %(Reg24 reg24, uint i) { throw new NotImplementedException(); }
            public Reg24() { throw new NotImplementedException(); }
        }
    }
}

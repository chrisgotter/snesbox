...
namespace Snes
{
    class Video
    {
        ...
        public void update()
        {
            ...
            var data = new ArraySegment<ushort>(PPU.ppu.Output);
            ...
            System.system.Interface.video_refresh(new ArraySegment<ushort>(PPU.ppu.Output, 1024, PPU.ppu.Output.Length - 1024), width, height);
